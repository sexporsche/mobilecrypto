...
public abstract class Hilt_CoinListFragment extends MainNavigationFragment implements GeneratedComponentManager<Object> {
  ...
  protected void inject() {
    ((CoinListFragment_GeneratedInjector) generatedComponent()).injectCoinListFragment(UnsafeCasts.<CoinListFragment>unsafeCast(this));
  }
